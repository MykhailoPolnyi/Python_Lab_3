...
class Test:
    ...
    def main(cls):
        ...
        zoo_aq_1 = Aquarium(700, 15, 30, [LightingLevel.LightingLevel.MEDIUM, LightingLevel.LightingLevel.DARK])

        aq_anim_4 = Fish.Fish(3, Thermoregulation.ThermoregulationType.COLD_BLOODED, 2, "Clownfish", 250, 20,
                              LightingLevel.LightingLevel.MEDIUM, "White-orange", zoo_aq_1)

        zoo_aq_2 = Aquarium(500, 15, 25, LightingLevel.LightingLevel.MEDIUM, [aq_anim_3, aq_anim_1])

        zoo_manger_1 = ZooManager.ZooManager([aq_anim_1, aq_anim_2, aq_anim_3, aq_anim_4])

        aquariums_manager_1 = AquariumsManager.AquariumsManager([aq_anim_1, aq_anim_3], [zoo_aq_1, zoo_aq_2])
        ...
        aquariums_manager_1.all_animals.extend([aq_anim_4, aq_anim_2])
        aquariums_manager_1.change_animal_aquarium(aq_anim_2, zoo_aq_1)
        ...
        print("\nAquarium testing:")
        print(zoo_aq_1.inhabitants)
        print(zoo_aq_1.supported_lighting_level)
        print(zoo_aq_2.__dict__)
        aquariums_manager_1.sort_animal_list_by_aquarium_capacity()
